...
{
    public class PlayerPropConstants
    {
        ...
        public const string KambiTouchdownScorer = "Touchdown Scorer";
        public const string KambiFirstFieldGoal = "Player to Score the First Field Goal of the Game";
