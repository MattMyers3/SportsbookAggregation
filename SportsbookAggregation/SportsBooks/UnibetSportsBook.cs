...
namespace SportsbookAggregation.SportsBooks
{
    public class UnibetSportsBook : ISportsBook
    {
        private const string NbaRequestUrl =
            "https://eu-offering.kambicdn.org/offering/v2018/ubuspa/listView/basketball/nba.json?lang=en_US&market=US&client_id=2&channel_id=1&ncid=1600113940467&useCombined=true";
        private const string NflRequestUrl =
            "https://eu-offering.kambicdn.org/offering/v2018/ubuspa/listView/american_football/nfl.json?lang=en_US&market=US&client_id=2&channel_id=1&ncid=1600101642874&useCombined=true";
